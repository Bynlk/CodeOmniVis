...
const VIEWS: Array<{ id: WorkbenchView; labelKey: string; defaultLabel: string; icon: WorkbenchIconName }> = [
        ...
        {VIEWS.map(view => {
          ...
          return (
            ...
            >
              ...
              {view.id === 'quality' && issueCount > 0 ? <span className="absolute right-0.5 top-0.5 h-1.5 w-1.5 rounded-full bg-rose-400" /> : null}
            </button>
          )
        })}
      </div>
