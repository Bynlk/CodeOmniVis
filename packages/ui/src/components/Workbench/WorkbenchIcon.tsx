...
const paths: Record<WorkbenchIconName, React.ReactNode> = {
  ...
  quality: (
    <>
      <path d="M12 3 4 7v5c0 4.8 3.2 7.7 8 9 4.8-1.3 8-4.2 8-9V7l-8-4Z" />
  ...
  branch: (
    <>
      ...
      <path d="M6 7v10M8 8c6 0 4-2 8-2" />
    </>
  ),
  database: (
    <>
      <ellipse cx="12" cy="5" rx="7" ry="3" />
      <path d="M5 5v7c0 1.7 3.1 3 7 3s7-1.3 7-3V5M5 12v6c0 1.7 3.1 3 7 3s7-1.3 7-3v-6" />
    </>
  ),
}
...
export function WorkbenchIcon({
  name,
  ...props
}: { name: WorkbenchIconName } & SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
