...
```bash
pnpm add -D vitest supertest @types/supertest --filter @codeomnivis/server
```
...
```bash
pnpm add -D eslint @eslint/js typescript-eslint --filter codeomnivis
```
...
- `docs/superpowers/specs/2026-06-06-codeomnivis-design.md` — 更新解析引擎描述
...
```json
{
  "repository": {
    "type": "git",
    "url": "https://github.com/YOUR_USERNAME/codeomnivis.git",
    "directory": "packages/PACKAGE_NAME"
  },
  "homepage": "https://github.com/YOUR_USERNAME/codeomnivis#readme",
  "keywords": ["codeomnivis", "architecture", "visualization", "typescript"],
  "publishConfig": {
    "access": "public"
  }
}
...
| P1-1 server 测试 | `pnpm --filter @codeomnivis/server test`          | 10 个测试通过           |
| P1-2 cli 测试    | `pnpm --filter @codeomnivis/cli test`             | 6 个测试通过            |
...
_计划书版本：1.0 | 基于 2026-06-06 全量代码扫描_
