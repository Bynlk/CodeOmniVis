...
![CodeOmniVis - 别再让 AI 猜你的架构](docs/assets/readme/og-cover.jpeg)
...
![从仓库到图谱：一次扫描，多端消费](docs/assets/readme/repo-to-graph.jpeg)
...
![agent 负责行动，CodeOmniVis 负责证明结构](docs/assets/readme/agent-vs-context-layer.jpeg)
...
![CodeOmniVis 能力全景](docs/assets/readme/readme-feature-banner.jpeg)
...
![通过 MCP 直接向 AI 查询架构上下文](docs/assets/readme/mcp-query-card.jpeg)
